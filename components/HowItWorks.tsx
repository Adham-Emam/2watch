          ...
          {cards.map((card, index) => (
            ...
            >
              <motion.div
                ...
                className="text-2xl font-bold absolute top-0 left-1/2 -translate-1/2 btn-gradient-rose text-white w-12 aspect-square rounded-full flex items-center justify-center"
              >
                <ShadowOverlay
                  center
                  size="w-50 h-50"
