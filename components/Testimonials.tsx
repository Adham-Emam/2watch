    ...
    <section className="container py-20 relative">
      ...
      <AnimatePresence>
        <motion.div
          ...
          className="glass-card relative max-w-250 mx-auto mt-15 rounded-2xl  flex flex-col md:flex-row items-center justify-between gap-8 px-4 lg:px-2 py-12"
        >
          ...
          <div className="flex-3">
            <p className="text-3xl my-6 font-semibold">
              "It used to take us 45 minutes to pick a movie. 2Watch does it in
              30 seconds. Best date night upgrade ever!"
            </p>
